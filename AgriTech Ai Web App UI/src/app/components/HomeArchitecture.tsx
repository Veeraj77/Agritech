...
const agents = [
  {
    ...
    description: "Leverage deep learning to analyze multi-year harvest patterns, soil moisture, and weather forecasts for high-precision tonnage estimates.",
    icon: TrendingUp,
    color: "#2E7D32", 
    bgColor: "bg-[#E8F5E9]",
    path: "/agent-yield",
    outputs: ["Estimated Tonnage"],
  },
  {
    id: 2,
    title: "Step 2: Plan Your Storage",
    shortTitle: "Storage Optimization",
    description: "Automate facility matching by cross-referencing harvest volume with regional warehouse capacity and specialized climate requirements.",
    icon: Warehouse,
    color: "#7c3aed", // Purple as requested
    bgColor: "bg-purple-50",
    path: "/agent-storage",
    outputs: ["Optimal Facility", "Utilization Rate"],
  },
  {
    id: 3,
    title: "Step 3: Check Market Prices",
    shortTitle: "Market Analysis",
    description: "Real-time arbitrage analysis to identify peak demand zones and historical price trends for maximized commodity valuation.",
    icon: DollarSign,
    color: "#F9A825", 
    bgColor: "bg-[#FFF8E1]",
    path: "/agent-price",
    outputs: ["Target Market", "Projected Valuation"],
  },
  {
    id: 4,
    title: "Step 4: Book Your Transport",
    shortTitle: "Transport Planning",
    description: "Algorithmic route optimization to secure cost-effective logistics and ensure timely transit from storage nodes to the point of sale.",
    icon: Truck,
    color: "#689F38", 
    bgColor: "bg-[#F1F8E9]",
    path: "/agent-transport",
    outputs: ["Logistics Quote", "Transit Schedule"],
  },
];
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-[#2E7D32] via-[#81C784] to-[#F9A825] text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-20 max-w-5xl mx-auto">
            {[
              { value: "95%", label: "Accuracy Rate", icon: CheckCircle2, color: "#FFE082" },
              { value: "4", label: "AI Agents", icon: Brain, color: "#81C784" },
              { value: "10K+", label: "Active Farmers", icon: TrendingUp, color: "#FFE082" },
              { value: "24/7", label: "Availability", icon: Zap, color: "#81C784" },
            ].map((stat, idx) => (
