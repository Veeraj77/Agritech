...
const agents = [
  {
    ...
    description: "AI-powered forecasting for accurate yield estimation",
    icon: TrendingUp,
  ...
  },
  {
    ...
    description: "Optimize storage facilities and reduce waste",
    icon: Warehouse,
  ...
  },
  {
    ...
    description: "Find best markets and maximize profits",
    icon: DollarSign,
  ...
  },
  {
    ...
    description: "Cost-effective logistics planning",
    icon: Truck,
